        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square rounded-3xl overflow-hidden bg-muted glass-card">
                <img
                  src={product.image}
                  alt={product.name}
            ...
            >
              ...
              {/* Scent Notes */}
              <div>
                <h3 className="font-semibold mb-4 text-lg">Scent Notes</h3>
                <div className="flex flex-wrap gap-3">
                  {product.notes.map((note) => (
                    <motion.span
                      key={note}
                      whileHover={{ scale: 1.05 }}
                      className="px-5 py-2 bg-muted rounded-full text-sm font-medium"
                    >
                      {note}
                    </motion.span>
                  ))}
              ...
              <div className="space-y-3">
                ...
                <Button
                  className="w-full bg-[#25D366] hover:bg-[#25D366]/90 text-white hover-glow"
                  size="lg"
